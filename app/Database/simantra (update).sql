...
--
-- Host: localhost:3306
-- Generation Time: Dec 11, 2023 at 11:25 AM
...
-- Database: `simantra`
--
CREATE DATABASE IF NOT EXISTS `simantra` DEFAULT CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci;
USE `simantra`;
...
CREATE TABLE `bobot_kriteria` (
  ...
  `kriteria` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `bobot` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
...
CREATE TABLE `rekap_nilai_mitra` (
  ...
  `id_nilai_kegiatan_mitra` int NOT NULL,
  `nama_mitra` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
