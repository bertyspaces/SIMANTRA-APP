...
<body>
    ...
    <p>Berdasarkan hasil penilaian dan perhitungan dengan metode <i>Fuzzy Simple Additive Weighting</i> yang telah diikuti mitra lapangan pada Kegiatan <?= $kegiatan['nama_kegiatan'] ?>Periode <?= $kegiatan['periode'] ?>, maka berikut adalah Data Ranking Kinerja Mitra :</p>

    <h4>Data Rangking Kinerja Mitra Lapangan Kegiatan <?= $kegiatan['nama_kegiatan'] ?>Periode <?= $kegiatan['periode'] ?></h4>
    </center>
    <table>
        <thead>
            <tr>
